	        ...
	        <ul class="nav navbar-top-links navbar-right">
	            <li class="dropdown">
	                ...
	                <ul class="dropdown-menu dropdown-user">
	                    <li><a href="admin/profile.php"><i class="fa fa-user fa-fw"></i> Perfil</a>
	                    </li>
	                    <li><a href="admin/config.php"><i class="fa fa-gear fa-fw"></i> Configurações</a>
	                    </li>
	                    <li><a href="admin/adminoptions.php"><i class="fa fa-users fa-fw"></i> Administrador</a>
	                    </li>
	                    <li class="divider"></li>
	                    <li><a href="admin/logout.php"><i class="fa fa-sign-out fa-fw"></i> Sair</a>
	                    </li>
	                </ul>
	                <!-- /.dropdown-user -->
	            </li>
	    ...
	    <div id="page-wrapper">
	    	<div class="container-fluid">
				<div class="form-signin">
					...
					<a href="admin/logout.php" class="btn btn-default btn-lg btn-block">Sair</a>
				</div>
			</div>
	    </div>
	</div>
